...
public class fichamedicaController {
    ...
    public @ResponseBody String getAllFichaMedica() {
        ...
        for (fichamedica _fichamedica : iterable) {
            resp += "<tr>"
                    + "<td>" + _fichamedica.getIdmedfic() + "</td>"
                    + "<td>" + _fichamedica.getObrasoc() + "</td>"
                    + "<td>" + _fichamedica.getPreocupacional() + "</td>"
                    + "<td>" + _fichamedica.getFechapreocupacional() + "</td>"
                    + "<td>" + _fichamedica.getPatprevias() + "</td>"
                    + "</tr>";
        }
        return resp + "</table>";
    }
